...
if (isset($_POST['x'])){
    ...
    $insert_pic_query = mysqli_query($con, "UPDATE user SET profile_pic='$result_path' WHERE user_name='$userLoggedIn'");
...
<div class="main_column column">
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
        ...
        <div id="CroppingContainer" style="width:800px; max-height:600px; background-color:#FFF; margin-left: -200px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">
            ...
            <div id="CroppingArea" style="width:500px; max-height:400px; position:relative; overflow:scroll; margin:40px 0px 40px 40px; border:2px #666 solid; float:left;">
            ...
            <div id="InfoArea" style="width:180px; height:150px; position:relative; overflow:scroll; margin:40px 0px 0px 40px; border:0px #666 solid; float:left;">
